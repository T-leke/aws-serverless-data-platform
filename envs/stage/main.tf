...
module "iam" {
  ...
  project_name      = var.project_name
  environment       = var.environment
  source_bucket_arn = module.s3_data_lake.source_bucket_arn
...
module "lambda_validator" {
  ...
  project_name      = var.project_name
  environment       = var.environment
  source_bucket_id  = module.s3_data_lake.source_bucket_id
  source_bucket_arn = module.s3_data_lake.source_bucket_arn
...
module "glue" {
  ...
  source_bucket_name = module.s3_data_lake.source_bucket_name
...
module "athena" {
  ...
  project_name               = var.project_name
  environment                = var.environment
  athena_results_bucket_name = module.s3_data_lake.gold_bucket_name
}
